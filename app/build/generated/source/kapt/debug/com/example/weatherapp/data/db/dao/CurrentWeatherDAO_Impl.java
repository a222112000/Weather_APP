...
public final class CurrentWeatherDAO_Impl implements CurrentWeatherDAO {
  ...
  public CurrentWeatherDAO_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfWeatherApi = new EntityInsertionAdapter<WeatherApi>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `current_weather` (`id`,`current_temperature`,`current_weather_icons`,`current_observation_time`,`current_precip`,`current_cloudcover`,`current_wind_dir`,`current_wind_speed`,`current_feelslike`,`current_visibility`,`location_country`,`location_name`,`location_localtime`,`location_timezone_id`,`location_region`,`location_localtime_epoch`,`request_language`,`request_query`) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      public void bind(SupportSQLiteStatement stmt, WeatherApi value) {
        ...
        if(_tmpLocation != null) {
          if (_tmpLocation.getCountry() == null) {
            ...
            stmt.bindString(11, _tmpLocation.getCountry());
          }
          if (_tmpLocation.getName() == null) {
            stmt.bindNull(12);
          } else {
            stmt.bindString(12, _tmpLocation.getName());
          }
          if (_tmpLocation.getLocaltime() == null) {
            stmt.bindNull(13);
          } else {
            stmt.bindString(13, _tmpLocation.getLocaltime());
          }
          if (_tmpLocation.getTimezone_id() == null) {
            stmt.bindNull(14);
          } else {
            stmt.bindString(14, _tmpLocation.getTimezone_id());
          }
          if (_tmpLocation.getRegion() == null) {
            stmt.bindNull(15);
          } else {
            stmt.bindString(15, _tmpLocation.getRegion());
          }
          if (_tmpLocation.getLocaltime_epoch() == null) {
            stmt.bindNull(16);
          } else {
            stmt.bindLong(16, _tmpLocation.getLocaltime_epoch());
          }
        } else {
          stmt.bindNull(11);
          stmt.bindNull(12);
        ...
        if(_tmpRequest != null) {
          if (_tmpRequest.getLanguage() == null) {
            ...
            stmt.bindString(17, _tmpRequest.getLanguage());
          }
          if (_tmpRequest.getQuery() == null) {
            stmt.bindNull(18);
          } else {
            stmt.bindString(18, _tmpRequest.getQuery());
          }
        } else {
          stmt.bindNull(17);
          stmt.bindNull(18);
  ...
  @Override
  public void upsert(final WeatherApi weaterEntry) {
    __db.assertNotSuspendingTransaction();
    __db.beginTransaction();
    try {
      __insertionAdapterOfWeatherApi.insert(weaterEntry);
  ...
  public LiveData<MetricCurrentWeatherEntry> getWeatherMetric() {
    final String _sql = "select * from current_weather ";
  ...
  @Override
  public LiveData<ImperialCurrentWeather> getWeatherImperail() {
    final String _sql = "select * from current_weather";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
    return __db.getInvalidationTracker().createLiveData(new String[]{"current_weather"}, false, new Callable<ImperialCurrentWeather>() {
      @Override
      public ImperialCurrentWeather call() throws Exception {
        final Cursor _cursor = DBUtil.query(__db, _statement, false, null);
        try {
          final int _cursorIndexOfCurrentTemperature = CursorUtil.getColumnIndexOrThrow(_cursor, "current_temperature");
          final int _cursorIndexOfCurrentWeatherIcons = CursorUtil.getColumnIndexOrThrow(_cursor, "current_weather_icons");
          ...
          final int _cursorIndexOfLocationLocaltimeEpoch = CursorUtil.getColumnIndexOrThrow(_cursor, "location_localtime_epoch");
          final int _cursorIndexOfRequestLanguage = CursorUtil.getColumnIndexOrThrow(_cursor, "request_language");
          final ImperialCurrentWeather _result;
          if(_cursor.moveToFirst()) {
            final int _tmpCurrentTemperature;
            _tmpCurrentTemperature = _cursor.getInt(_cursorIndexOfCurrentTemperature);
            final List<String> _tmpCurrentWeatherIcons;
            ...
            _result = new ImperialCurrentWeather(_tmpCurrentTemperature,_tmpCurrentWeatherIcons,_tmpCurrentObservationTime,_tmpCurrentPrecip,_tmpCurrentCloudcover,_tmpCurrentWind_dir,_tmpCurrentWind_speed,_tmpCurrentFeelslike,_tmpCurrentVisibility,_tmpLocationCountry,_tmpLocationName,_tmpLocationRegion,_tmpLocationLocaltime,_tmpLocationTimezone_id,_tmpLocationLocaltime_epoch,_tmpRequestLanguage);
          } else {
            _result = null;
          }
          return _result;
